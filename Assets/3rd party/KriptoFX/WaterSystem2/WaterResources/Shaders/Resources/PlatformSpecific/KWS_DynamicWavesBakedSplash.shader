Shader "Hidden/KriptoFX/KWS2/KWS_DynamicWavesBakedSplash"
{
    Properties
    {
        _MainTex("Main Texture", 2D) = "white" {}
		
    	KWS_SplashParticlesAlphaMultiplier("KWS_SplashParticlesAlphaMultiplier", Float) = 1
    ...
    SubShader
    {
        ...
        Pass
        {
			...
			#pragma shader_feature _ KWS_USE_PER_VERTEX_SHADOWS
            ...
            v2f vert(appdata_t v)
            {
                ...
                o.vertex = ObjectToClipPos(v.vertex + float4(0, HEIGHT_OFFSET, 0, 0));
                o.color = v.color;
                o.uv.xy = v.uv.xy * _MainTex_ST.xy + _MainTex_ST.zw;
				o.particleRandom01 = v.uv.z;
                o.screenPos = ComputeScreenPos(o.vertex);
                o.worldPos = LocalToWorldPos(v.vertex.xyz + float3(0, HEIGHT_OFFSET, 0));
