...
namespace KWS
{
    ...
    internal class DynamicWavesPass : WaterPass
    {
        ...
        void UpdateSimulationMap(Camera cam)
        {
            ...
            CoreUtils.SetRenderTarget(_cmdMap, _dynamicWavesMap,               ClearFlag.All, new Color(-10, -10, 0, 0),   depthSlice: -1);
            CoreUtils.SetRenderTarget(_cmdMap, _dynamicWavesAdditionalDataMap, ClearFlag.All, Color.clear,                 depthSlice: -1);
            CoreUtils.SetRenderTarget(_cmdMap, _dynamicWavesNormalAndWetMap,   ClearFlag.All, new Color(0.5f, 0.5f, 0, 0), depthSlice: -1);
            ...
            {
                CoreUtils.SetRenderTarget(_cmdMap, _dynamicWavesColorMap, ClearFlag.All, Color.clear, depthSlice: -1);
            }

            if (KWS_TileZoneManager.IsAnyZoneUseAdvectedUV) CoreUtils.SetRenderTarget(_cmdMap, _dynamicWavesAdvectedUVMap, ClearFlag.All, Color.clear, depthSlice: -1);
